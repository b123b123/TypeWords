...
function getUtils(options, customizedDeepmerge) {
  ...
  return {
    ...
    metaDataUpdater:
      (_options$metaDataUpda = options.metaDataUpdater) != null ? _options$metaDataUpda : defaultMetaDataUpdater,
    deepmerge: customizedDeepmerge,
    useImplicitDefaultMerging:
      (_options$enableImplic = options.enableImplicitDefaultMerging) != null ? _options$enableImplic : false,
    filterValues:
...
function mergeUnknowns(values, utils, meta) {
  ...
  const filteredValues =
    (_utils$filterValues = utils.filterValues == null ? void 0 : utils.filterValues(values, meta)) != null
      ? _utils$filterValues
      : values
...
async function detectOverflow(state, options) {
  ...
  const clippingClientRect = rectToClientRect(
    await platform.getClippingRect({
      element: (
        (_await$platform$isEle = await (platform.isElement == null ? void 0 : platform.isElement(element))) != null
          ? _await$platform$isEle
          : true
      )
        ? element
        : element.contextElement ||
          (await (platform.getDocumentElement == null ? void 0 : platform.getDocumentElement(elements.floating))),
      boundary,
      rootBoundary,
      strategy,
    })
  ...
  return {
    ...
    async fn(state) {
      ...
      const _evaluate = evaluate(options, state),
        { crossAxis = false, alignment, allowedPlacements = placements, autoAlignment = true } = _evaluate,
      ...
      const currentIndex =
        ((_middlewareData$autoP = middlewareData.autoPlacement) == null ? void 0 : _middlewareData$autoP.index) || 0
      ...
      if (!overflows.every(side => side <= 0)) {
        ...
        if (nextPlacement) {
          ...
          const hasInitialMainAxisOverflow =
            ((_overflowsData$ = overflowsData[0]) == null ? void 0 : _overflowsData$.overflows[0]) > 0
    ...
    fn(state) {
      ...
      if (checkCrossAxis) {
        ...
        const limitMin =
          ...
          rects.floating[len] +
          (isOriginSide
            ? ((_middlewareData$offse = middlewareData.offset) == null ? void 0 : _middlewareData$offse[crossAxis]) || 0
            : 0) +
        ...
        const limitMax =
          ...
          (isOriginSide
            ? 0
            : ((_middlewareData$offse2 = middlewareData.offset) == null ? void 0 : _middlewareData$offse2[crossAxis]) ||
              0) -
...
function getFloatingUIOptions(attachToOptions, step) {
  ...
  const hasAutoPlacement =
    (_attachToOptions$on = attachToOptions.on) == null ? void 0 : _attachToOptions$on.includes('auto')
  const hasEdgeAlignment =
    (attachToOptions == null || (_attachToOptions$on2 = attachToOptions.on) == null
      ? void 0
      : _attachToOptions$on2.includes('-start')) ||
    (attachToOptions == null || (_attachToOptions$on3 = attachToOptions.on) == null
      ? void 0
      ...
      options.middleware.push(
        autoPlacement({
          ...
          alignment: hasEdgeAlignment
            ? attachToOptions == null || (_attachToOptions$on4 = attachToOptions.on) == null
              ? void 0
...
function ensure_array_like(array_like_or_iterator) {
  return (array_like_or_iterator == null ? void 0 : array_like_or_iterator.length) !== undefined
  ...
  return {
    c() {
      ...
      attr(
        button,
        'class',
        (button_class_value = `${/*classes*/ ctx[1] || ''} shepherd-button ${/*secondary*/ ctx[4] ? 'shepherd-button-secondary' : ''}`)
      )
    ...
    p(new_ctx, [dirty]) {
      ...
      if (
        dirty & /*label*/ 8 &&
        button_aria_label_value !== (button_aria_label_value = /*label*/ ctx[3] ? /*label*/ ctx[3] : null)
      ) {
  ...
  return {
    c() {
      ...
      attr(
        button,
        'aria-label',
        (button_aria_label_value = /*cancelIcon*/ ctx[0].label ? /*cancelIcon*/ ctx[0].label : 'Close Tour')
      )
...
function create_fragment$2(ctx) {
  ...
  let show_if_2 =
    ...
    /*step*/ (ctx[2].options.cancelIcon && /*step*/ ctx[2].options.cancelIcon.enabled)
  let t0
  ...
  return {
    ...
    p(ctx, [dirty]) {
      ...
      if (dirty & /*step*/ 4)
        show_if = Array.isArray(/*step*/ ctx[2].options.buttons) && /*step*/ ctx[2].options.buttons.length
      if (show_if) {
        if (if_block2) {
...
function create_fragment$1(ctx) {
  ...
  let dialog_levels = [
    {
      'aria-describedby': (dialog_aria_describedby_value = !isUndefined(/*step*/ ctx[4].options.text)
        ? /*descriptionId*/ ctx[2]
        : null),
    },
    {
          ...
          (!current ||
            (dirty & /*step, descriptionId*/ 20 &&
              dialog_aria_describedby_value !==
                (dialog_aria_describedby_value = !isUndefined(/*step*/ ctx[4].options.text)
                  ? /*descriptionId*/ ctx[2]
                  : null))) && {
          ...
          (!current ||
            (dirty & /*step, labelId*/ 24 &&
              dialog_aria_labelledby_value !==
                (dialog_aria_labelledby_value = /*step*/ ctx[4].options.title ? /*labelId*/ ctx[3] : null))) && {
...
function instance$1($$self, $$props, $$invalidate) {
  ...
  $$self.$$set = $$props => {
    ...
    if ('attachTofocusableDialogElements' in $$props)
      $$invalidate(15, (attachTofocusableDialogElements = $$props.attachTofocusableDialogElements))
    if ('classPrefix' in $$props) $$invalidate(16, (classPrefix = $$props.classPrefix))
    if ('element' in $$props) $$invalidate(0, (element = $$props.element))
    if ('descriptionId' in $$props) $$invalidate(2, (descriptionId = $$props.descriptionId))
    if ('focusableAttachToElements' in $$props)
      $$invalidate(9, (focusableAttachToElements = $$props.focusableAttachToElements))
    if ('firstFocusableAttachToElement' in $$props)
      $$invalidate(10, (firstFocusableAttachToElement = $$props.firstFocusableAttachToElement))
    if ('lastFocusableAttachToElement' in $$props)
      $$invalidate(11, (lastFocusableAttachToElement = $$props.lastFocusableAttachToElement))
    if ('firstFocusableDialogElement' in $$props)
      $$invalidate(12, (firstFocusableDialogElement = $$props.firstFocusableDialogElement))
    if ('focusableDialogElements' in $$props)
      $$invalidate(13, (focusableDialogElements = $$props.focusableDialogElements))
    if ('lastFocusableDialogElement' in $$props)
      $$invalidate(14, (lastFocusableDialogElement = $$props.lastFocusableDialogElement))
...
class Step extends Evented {
  ...
  _styleTargetElementForStep(step) {
    ...
    extraHighlightElements == null ||
      extraHighlightElements.forEach(el => el.classList.remove('shepherd-target-click-disabled'))
    if (step.options.canClickTarget === false) {
      targetElement.classList.add('shepherd-target-click-disabled')
      extraHighlightElements == null ||
        extraHighlightElements.forEach(el => el.classList.add('shepherd-target-click-disabled'))
    }
  }
  ...
  return {
    c() {
      ...
      attr(
        svg,
        'class',
        (svg_class_value = `${/*modalIsVisible*/ ctx[1] ? 'shepherd-modal-is-visible' : ''} shepherd-modal-overlay-container`)
      )
    },
    m(target, anchor) {
  ...
  while (targetWindow !== window.top) {
    ...
    if (targetIframe) {
      ...
      offset.top +=
        ...
        ((_targetIframeRect$scr = targetIframeRect.scrollTop) != null ? _targetIframeRect$scr : 0)
      offset.left +=
        targetIframeRect.left +
        ((_targetIframeRect$scr2 = targetIframeRect.scrollLeft) != null ? _targetIframeRect$scr2 : 0)
    }
    ...
    if (targetElement) {
      ...
      for (const element of elementsToHighlight) {
        ...
        const isContained = elementsToHighlight.some(otherElement => {
          ...
          return (
            x >= otherRect.left && x + width <= otherRect.right && y >= otherRect.top && y + height <= otherRect.bottom
          )
        })
